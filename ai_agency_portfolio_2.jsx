  ...
  const sqlDemos = [
    {
      ...
      metrics: { queries: '1.2M/day', latency: '< 50ms', uptime: '99.9%' }
    },
    {
      ...
      metrics: { segments: '12', accuracy: '94%', processing: '< 2s' }
    },
    {
      ...
      metrics: { reports: '500+/mo', automation: '100%', time_saved: '200h' }
    }
  ];
          ...
          <div className="bg-gray-900 dark:bg-black rounded-xl border border-gray-700 overflow-hidden">
            ...
            <div className="p-6">
              <pre className="text-green-400 font-mono text-sm mb-6 overflow-x-auto">
                {sqlDemos[activeDemo].query}
              </pre>
              
              <div className="grid grid-cols-3 gap-4">
                {Object.entries(sqlDemos[activeDemo].metrics).map(([key, value]) => (
